 ...
 */
class AdminPartnerFeedItemController extends ModuleAdminController
{
    /**
     * @inheritdoc
     */
    public function __construct()
    {
        ...
        $this->token        = Tools::getAdminTokenLite('AdminPartnerFeedItem');
     ...
     * 
     * @param int $id_type ID типа файла
     * 
     * @return string $file_type_name Наименование типа экспортируемого файла
     */
    public function getFileTypeName($id_type): string
    {
        $file_type_name = PartnerFeedClass::getFileTypeName($id_type);
